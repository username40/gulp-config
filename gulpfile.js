...
let path = {
    ...
    src: {
        ...
        grid: `${sourceFolder}/grid/bootstrap-grid.min.css`,
...
let build = gulp.series(clean, gulp.parallel(js, css, html, images, fonts, grid), fontsStyle);
